...
parser.add_argument('--path_to_txt', type=str,default='/content/drive/MyDrive/DomainToText_AMLProject/data/PACS/', help='path to the txt files')
parser.add_argument('--path_to_dataset', type=str, default='/content/drive/MyDrive/DomainToText_AMLProject/data/',help='path to the dataset')
...
def main():
    ...
    G1.load_state_dict(torch.load('/content/drive/MyDrive/DomainToText_AMLProject/outputs/SingleSource_'+sources[0] + '/G.pkl'))
    C1.load_state_dict(torch.load('/content/drive/MyDrive/DomainToText_AMLProject/outputs/SingleSource_'+sources[0] + '/C.pkl'))
    ...
    G2.load_state_dict(torch.load('/content/drive/MyDrive/DomainToText_AMLProject/outputs/SingleSource_'+sources[1] + '/G.pkl'))
    C2.load_state_dict(torch.load('/content/drive/MyDrive/DomainToText_AMLProject/outputs/SingleSource_'+sources[1] + '/C.pkl'))
    ...
    G3.load_state_dict(torch.load('/content/drive/MyDrive/DomainToText_AMLProject/outputs/SingleSource_'+sources[2] + '/G.pkl'))
    C3.load_state_dict(torch.load('/content/drive/MyDrive/DomainToText_AMLProject/outputs/SingleSource_'+sources[2] + '/C.pkl'))
    ...
    model_path = '/content/drive/MyDrive/DomainToText_AMLProject/outputs/triplet_match/BEST_checkpoint.pth'
